...
void VSmoveBlock(int P1choice, int P2choice)
{
    ...
    } while (collide == true); // issue flag: might reset Player 2/ Player 1
...
void vsMode()
{
    ...
    P1nextChoice = P1generateRandomNumber(); 
    P2nextChoice = P2generateRandomNumber();  
    ...
    while (P1gameOver == false && P2gameOver == false) 
    {
        ...
        P1currentChoice = P1nextChoice;
        P2currentChoice = P2nextChoice;  
        P1nextChoice = P1generateRandomNumber();  
        P2nextChoice = P2generateRandomNumber();
    }
}
